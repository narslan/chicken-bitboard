...
;;builds a new bit vector from another bit vector while index id of vector is set to 0
...
;; update pieces, but this can be done more compact with a macro
...
;; bbindex enumerate board pieces onto a vector of 64...
;; ['blackPawn #f #f ... ]
